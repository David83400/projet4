        ...
        <div class="row">
            <div class="col-8 offset-2 col-md-4 offset-md-4">
                <div class="changeMdp text-center">
                    ...
                    <?php if (isset($_POST['formChangeMdp'])) { ?>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group d-flex flex-column">
                            <label for="newPass">Votre nouveau mot de passe <span>(8 caractères minimum)</span></label><input id="newPass" name="newPass" type="password" />
                        </div>
                        <div class="form-group d-flex flex-column">
